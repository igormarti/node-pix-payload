...
test('Testing payload text static',async ()  => {
    ...
    expect( (await payload.getData()).text_payload ).
    toBe('00020126730014br.gov.bcb.pix01361c995784-b8a4-482a-952e-4b8cd69282160211payment xyz5204000053039865406100.005802BR5912IJ Solutions6006MACEIO62090505ij1236304BAA9');
})
...
test('Testing payload text dynamic',async ()  => {
    ...
    expect( text ).
    toBe('00020101021226920014br.gov.bcb.pix2570qrpix.seupsp.com.br/qr/v2/c-8c7193b-34cc6180be87850a-89193060-9705a6b85204000053039865406548.785802BR5910IJ Company6006MACEIO62070503***6304DA32');
});
